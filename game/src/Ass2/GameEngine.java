...
//      |                                                                                  |
//      |         "GameEngine.java"is the game engine we used  for this game               |
...
public abstract class GameEngine implements KeyListener, MouseListener, MouseMotionListener {
	...
	// Ass2.Main Loop of the game. Runs continuously
	...
	public void gameLoop(int framerate) {
		...
		// Ass2.Main loop runs until program is closed
		timer.start();
	}
